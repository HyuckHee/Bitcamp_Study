...
<body>
	<font size="5"><p align="Center">게시판 쓰기</p></font>
	 ...
	 <form name="write_form" action="Notice_Write" method="get" onsubmit="return input_check()">
    	...
    	<p align="Center">
     	...
     	<p align="Center">
     		<a href="Notice_Board.jsp"><input type="button" name = "cancle" value="취소" onclick="return really()"></a>
