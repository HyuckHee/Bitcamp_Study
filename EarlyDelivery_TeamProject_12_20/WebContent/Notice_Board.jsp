...
<%
	...
	if(pagefile == null){
		pagefile = "Notice_Board_List.jsp";
	}
%>
...
<body>
	<font size="5"><p align="Center">공지사항</p></font>
	<p align="Center">
	...
	<Table style='margin-left: auto; margin-right: auto;'>
		<tr>
			<td width='100'>
				<form action = "Notice_Board_Write.jsp" method="get" onsubmit="return login_confirm()">
					<input type="submit" value="글쓰기">
				</form>
			</td>
			<td width='200'></td>
			<td width='200' align="right">
				<form action = "Notice_Search" method="get">
