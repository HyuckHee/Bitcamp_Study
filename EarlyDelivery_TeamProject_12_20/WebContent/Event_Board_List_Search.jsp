...
<%
	...
	db.DBConnection("ED");
	db.DBTable_Select_UserId(request, "ED", "Event_Board", search);
	db.DBTable_Reply_Amount(request, "ED", "Event_Reply");
	...
	for(int i = (index-1); i >= 0; i--){
		...
		out.println("<td width='300'><a href='Event_Board_Pw.jsp?ori_id="+ori_id+"'>"+title+"</a>");
