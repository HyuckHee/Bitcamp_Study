...
<body>
	<font size="5"><p align="Center">게시글 수정</p></font>
	 ...
	 <form name="modify_form" action="Notice_Modify" method="get" onsubmit="return input_check()">
    	...
    	<p align="Center">
     	...
     	<p align="Center">
     		<a href="Notice_Board.jsp"><input type="button" name = "cancle" value="취소" onclick="return cancle_conform()"></a>
