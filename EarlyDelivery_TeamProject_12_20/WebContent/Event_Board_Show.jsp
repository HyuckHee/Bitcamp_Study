...
<%
	...
	db.DBTable_Reply_Select_Id(request, "ED", "Event_Reply", ori_id);
...
<Table bgcolor="White" style="margin-left: auto; margin-right: auto;">
	...
	<tr>
		<td align="left"><a href = "Event_Board.jsp"><input type="button" value="목록보기"></a></td>
		<td align="right" width="400">
			<form name="modify_form" action="Event_Board_Modify.jsp" method="get" onsubmit="return modify_reconfirm()">
				<input type="submit" value="글 수정">
				<input type="hidden" name="ori_id" value="<%=request.getParameter("ori_id")%>">
			</form>	
		</td>
		<td align="right">
			<form name="delete_form" action="Event_Delete" method="get" onsubmit="return delete_reconfirm()">
...
<br>
	...
	<form name="reply_form" action="Event_Reply" method="get" onsubmit="return write_reply()">
		...
		for(int i = (index-1); i >= 0; i--){
			...
			if(reply_user_id != null && reply_text !=null){
				...
				if(Login_id.equals(reply_user_id) || Login_id.equals("admin")){
					...
					out.println("<form action='Event_Reply_Delete' method='get'>");
