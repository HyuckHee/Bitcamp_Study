...
/**
 * Servlet implementation class Event_Reply_Servlet
 */
@WebServlet("/Event_Reply")
public class Event_Reply_Servlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public Event_Reply_Servlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(login_id != "visitor") {
			...
			db.DB_Reply_Insert("ED", "Event_Reply", ori_id, login_id, reply_input);
		}
