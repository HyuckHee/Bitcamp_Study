...
/**
 * Servlet implementation class Notice_Reply_Delete_Servlet
 */
@WebServlet("/Notice_Reply_Delete")
public class Notice_Reply_Delete_Servlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public Notice_Reply_Delete_Servlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		db.DBTable_Reply_Delete("ED", "Notice_Reply", reply_id, reply_user_id, reply_text);
